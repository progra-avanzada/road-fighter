...
public class Jugador extends GameObject implements Updatable, Renderable, Collidator {
    ...
    public Jugador(int x, int y, Score score, Auto auto) {
            this.auto = auto;
    ...
    private IndividualSpriteAnimation initFlappyAnimation() {
        IndividualSpriteAnimation individualSpriteAnimation = new IndividualSpriteAnimation(
                new Image[]{imageBase}, render, Duration.millis(500));
