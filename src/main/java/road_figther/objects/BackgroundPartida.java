...
public class BackgroundPartida extends GameObject implements Updatable, Renderable {
	private VBox render;
	...
	public BackgroundPartida() {
		Image backgroundImage = new Image("file:src/main/resources/img/Fondo Menu Partida.jpg", cityWidth, cityHeight, false, false);
