...
public class RoadFigther extends GameObject implements Updatable, Renderable, Collidator {
	...
	public RoadFigther(int x, int y, Score score) {
		posY = y;
		posX = x;
		this.score = score;
