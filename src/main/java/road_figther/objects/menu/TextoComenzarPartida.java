...
public class TextoComenzarPartida extends GameObject implements Renderable {
	...
	public TextoComenzarPartida() {
		text = new Text("Press Enter to start");

		render = new VBox(text);
		render.setAlignment(Pos.BOTTOM_RIGHT);
